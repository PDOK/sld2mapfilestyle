...
if __name__ == "__main__":
	...
	#print '  WEB'
	#print '    METADATA'
	#print '      "ows_title"               "%s"' % serviceTitle
	#print '      "ows_abstract"            "%s"' % serviceTitle
	#print '      "ows_keywordlist"         "PDOK Geopackage Mapserver %s"' % serviceTitle
	...
	#print '      "wfs_namespace_prefix"    "%s"' % baseName
	#print '      "wfs_namespace_uri"       "http://example.org/pdok/%s"' % baseName
	#print '    END'
	#print '  END'
	#print ''
